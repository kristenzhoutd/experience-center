...
export default function PaidMediaSettingsPage() {
  ...
  return (
    <div className="h-full overflow-y-auto">
      <div className="px-6 py-4 border-b border-white/40 backdrop-blur-sm bg-white/60">
        <h2 className="text-lg font-semibold text-gray-900">Paid Media Settings</h2>
        <p className="text-sm text-gray-500">Configure your paid media integrations</p>
      </div>
